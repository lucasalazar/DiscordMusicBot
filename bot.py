...
class SubButton(discord.ui.View):
    def __init__(self):
        ...
        botaourl = discord.ui.Button(label="Conheça meu desenvolvedor",url="https://www.linkedin.com/in/lucasalazar/")
...
async def sync(ctx,guild=None):
    ...
    await ctx.send("**Sincronizado!** Finalmente consegui sincronizar essa merda, agora bora por o som na caixa!",view=SubButton())
